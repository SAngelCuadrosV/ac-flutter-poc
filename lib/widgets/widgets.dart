...
/// A platform-agnostic card representing a cocom which can be in a card state,
...
/// This is an example of a custom widget that an app developer might create for
/// use on both iOS and Android as part of their brand's unique design.
class HeroAnimatingCocomCard extends StatelessWidget {
  const HeroAnimatingCocomCard({
    required this.cocom,
    required this.color,
...
/// A loading cocom tile's silhouette.
///
/// This is an example of a custom widget that an app developer might create for
/// use on both iOS and Android as part of their brand's unique design.
class CocomPlaceholderTile extends StatelessWidget {
  const CocomPlaceholderTile({super.key});
